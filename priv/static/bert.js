...
export const decode = (buffer) => {
  ...
  const decodeType = () => {
    ...
    switch (type) {
      case 80:
        return read.slice(read.uint16());
      case 97:
        return read.uint8();
      case 98:
        return read.uint32();
      case 100:
        return utf8Decoder.decode(read.slice(read.uint16()));
      case 104:
        return decodeTuple(read.uint8());
      case 105:
        return decodeTuple(read.uint32());
      case 106:
        return [];
      case 108:
        return decodeList(read.uint32());
      case 109:
        return utf8Decoder.decode(read.slice(read.uint32()));
      case 110:
        return decodeBignum(read.uint8());
      case 111:
        return decodeBignum(read.uint32());
      case 115:
        return utf8Decoder.decode(read.slice(read.uint8()));
      case 116:
        return decodeMap(read.uint32());
      case 119:
        return utf8Decoder.decode(read.slice(read.uint8()));
      default:
